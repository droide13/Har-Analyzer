"""Grabs the app version out of the backend's own pyproject.toml.
...
# This file lives at <repo root>/backend/app/core/app_version.py, so two
# parents up gets us back to <repo root>/backend. Update this if the file
# ever moves.
